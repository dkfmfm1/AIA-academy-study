...
public class Menu {
   ...
   public static void showMenu2_2() {
      System.out.println("=================================================");
      System.out.println("*** 사용자 페이지입니다. 번호를 입력해주세요 ***");
      System.out.println("                  1. 로그인                     ");
      System.out.println("                  2. 회원가입                   ");
      System.out.println("=================================================");
   }
   ...
   public static void showMenu4() {
      ...
      System.out.println("  2. 재고 내역             ");
      System.out.println("  3. 거래처 정보           ");
      System.out.println("  4. 나가기                ");
      System.out.println("===========================");
	   }
   ...
   public static void showMenu5() {
      System.out.println("===========================");
      System.out.println("*** 번호를 입력해주세요 ***");
      System.out.println("   1. 고양이 용품 거래처   ");
      System.out.println("   2. 강아지 용품 거래처   ");
      System.out.println("===========================");
	   }
}